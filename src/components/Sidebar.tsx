...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onClose }) => {
  ...
  return (
    <aside className={`fixed inset-y-0 left-0 z-50 w-60 flex-shrink-0 flex flex-col bg-black text-ivory transition-transform duration-300 md:translate-x-0 ${isOpen ? 'translate-x-0 shadow-2xl' : '-translate-x-full'}`}>
